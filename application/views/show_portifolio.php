<div class="row banner2">
		...
		<div class="col-sm-4 col-sm-push-5"><a href="<?php echo base_url() ?>home/updatepage" class="banner2"><?php echo $info[0]->name; ?></a></div>
		...
		<div class="col-sm-9 col-sm-push-1 content_after_login">
			...
			<div class="row">
				<div class="col-sm-12 col-sm-push-3 ">
					<a href="<?php echo base_url() ?>home/portifolio"><button type="submit" class="btn btn-primary btn-lg" style="margin-left:12px" >UPDATE</button></a>
				</div>
			</div>
